...
# Для того, чтобы отправить метод запрос, с методом Post, нам необходимо прописать следующее:
...
# Отправлять запрос Get Мы уже умеем, поэтому давайте просто пропишем данный код:
